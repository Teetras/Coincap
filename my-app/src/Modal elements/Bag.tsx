...
//     {/* className={styles.modal_content}> className={styles.table} className={styles.close_button} */}
//         <h2>Bag Info</h2>
...
//     <td>
//     <button className={styles.btn} onClick={() => removeFromBag(currency.name)}>Remove</button>
//     </td>
//     </tr>
//     ))}
//     </tbody>
